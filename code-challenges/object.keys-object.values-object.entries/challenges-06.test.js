...
// console.log(Object.entries(pikachu));
...
// const pikaKeys = Object.keys(pikachu);
// console.log(pikaKeys);
...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach(object => {
    if (object.name === character) {
      if (Object.values(object)[2].length === 0) {
        output = false;
      }
      else if (Object.values(object)[2].length > 0) {
        console.log(true)
        output = true;
      }
    }
  ...
  // return false;
  // else if (character.values.length > 0);
  // return true;
};
...
const hasChildrenEntries = (arr, character) => {
  ...
  arr.forEach(object => {
    if (Object.entries(object)[0][1] === character) {
      if (Object.entries(object)[2][1][0]) {
        output = true;
      }
      else {
        output = false;
